...
const dict = {
  ar: {
    ...
    employeeOrders: "طلبات الموظف",
    devicesBreakdown: "تفاصيل الأجهزة",
    searchByDevice: "بحث باسم الجهاز",
    allDates: "كل الأيام",
    selectDate: "اختر التاريخ",
    customer: "الزبون",
    image_: "الصورة",
    showingFor: "عرض من أجل",
  ...
  en: {
    ...
    dateFilter: "Filter by day",
    deviceStats: "Devices breakdown",
    deviceCount: "Times registered",
    devicePrice: "Device price",
    deviceTotal: "Device total",
    grandTotal: "Grand total",
    devicesSum: "Sum of all devices",
    returnsSum: "Sum of returns",
    netTotal: "Net total",
    employeeStats: "Orders per employee",
